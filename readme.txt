...
*動作環境
・Windows7 64bitで動作確認しています。

・このソフトはMicrosoft Visual Studio 2013で作成しています。起動できない場合は↓等からMicrosoft .NET Framework 4.5以上のコンポーネントをインストールしてください。
...
*注意事項
・本ソフトウェアはフリーウェアです。本ソフトウェアのご利用に際し、如何なる損失や損害が発生しても、一切の責任を負いかねます。
